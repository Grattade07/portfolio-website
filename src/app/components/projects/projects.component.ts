  ...
  projects: {projectName: string, projectDescription:string, projectSourceURL: string, projectHostURL: string, previewImgPath: string}[] = [
    {
      ...
      projectDescription: 'A single-page web application that functions as an inventory management for a laboratory. Built using React and Bootstrap on the frontend, with Express and Mongoose communicating with MongoDB using a custom API, with middleware and JWTokens used to authenticate users.',
      projectSourceURL: 'https://github.com/Grattade07/laboratory-inventory',
      projectHostURL: 'https://laboratory-inventory.onrender.com/',
      previewImgPath: '/assets/project-preview-imgs/Lab-Inventory-List-Preview.png'
    },
    {
